	...
	open(1,file='l_vtan_BG_1978_CO',status='unknown')


	open(unit=2,file='8.5_220_l_b_r_vc_x_y_z_BG_CO',status='unknown')
	open(unit=3,file='8.0_200_l_b_r_vc_x_y_z_BG_CO',status='unknown')
	open(unit=4,file='8.3_244_l_b_r_vc_x_y_z_BG_CO',status='unknown')


        open(40,file='8.5_220_rmid_vcmean_errvc_BG_CO',status='unknown')
	open(50,file='8.0_200_rmid_vcmean_errvc_BG_CO',status='unknown')
        open(60,file='8.3_244_rmid_vcmean_errvc_BG_CO',status='unknown')
