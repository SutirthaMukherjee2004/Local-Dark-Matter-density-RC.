	...
	open(1,file='l_n_vtan_evtan_sig_errsig_clemens_1985_CO',status='unknown')

        open(unit=2,file='8.5_220_l_b_r_vc_x_y_z_Clemens_CO',status='unknown')
        open(unit=3,file='8.0_200_l_b_r_vc_x_y_z_Clemens_CO',status='unknown')
        open(unit=4,file='8.3_244_l_b_r_vc_x_y_z_Clemens_CO',status='unknown')

        open(40,file='8.5_220_rmid_vcmean_errvc_Clemens',status='unknown')
	open(50,file='8.0_200_rmid_vcmean_errvc_Clemens',status='unknown')
        open(60,file='8.3_244_rmid_vcmean_errvc_Clemens',status='unknown')
...
!
	...
	vsun3=244.d0
        ...
        do i=1,imax
        read(1,*)al(i),x1,vtan(i),x2,x3,x4
        end do
