...
open(unit=1,file='l_b_d_errd_vh_errv_FB_1989_HII',status='unknown')
open(unit=2,file='8.3_244_l_b_r_vc_x_y_z_FB_HII',status='unknown')
open(unit=3,file='8.3_244_rmid_vcmean_errvc_FB_HII',status='unknown')
