...
'./final_disk_8.0_200' u 1:2:3 with yerrorbars  pt 4 ps 2 lt 4 lw 4 lc rgb 'forest-green' title '[8.0,200]'
...
#################################################################################################
set out 'Fig4c_vc_disk_collapsed_8_200_compare_honma_2008_bw.eps'

set xra[0:25]  
set yra[0:550]

set key nobox top center spacing 2 samplen 6 at 15,525 font "Helvetica,30 "

plot './honma_2008_disk_8_200' u 1:($2*100):(($6-$5)*(100/2)) with yerrorbars pt 3 ps 2 lt 1 lw 4 lc rgb 'grey50' title 'Sofue et al., 2009',\
'./final_disk_8.0_200' u 1:2:3 with yerrorbars  pt 4 ps 2 lt 4 lw 4 lc rgb 'black' title 'RC Data (This Paper)'
################################################################################################
set out 'Fig4c_vc_disk_collapsed_8_200_compare_honma_2008_clr.eps'
...
plot './honma_2008_disk_8_200' u 1:($2*100):(($6-$5)*(100/2)) with yerrorbars pt 3 ps 2 lt 1 lw 4 lc rgb 'grey50' title 'Sofue et al., 2009',\
'./final_disk_8.0_200' u 1:2:3 with yerrorbars  pt 4 ps 2 lt 4 lw 4 lc rgb 'red' title 'RC Data (This Paper)'
